...
def gen_data_batch_longer(batch_size, start, end, digitlen):
    numbers_1 = np.random.uniform(start, end, batch_size) * (10 ** digitlen)
    numbers_2 = np.random.uniform(start, end, batch_size) * (10 ** digitlen)
    numbers1 = np.array([int(number) for number in numbers_1])
    numbers2 = np.array([int(number) for number in numbers_2])
    results = numbers1 + numbers2
    return numbers1, numbers2, results
