...
def gen_data_batch_large(batch_size,start,end):
    num_array_1 = []
    num_array_2 = []
    result_array = []
    for i in range(batch_size):
        num_array_1.append(random.randint(start, end))
        #print(len(str(num_array_1[i])))
        num_array_2.append(random.randint(start, end))
        result_array.append(num_array_1[i]+num_array_2[i])
    #print(num_array_1)
    return num_array_1, num_array_2, result_array
