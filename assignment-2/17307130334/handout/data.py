...
def gen_data_batch(batch_size, start, end):
    ...
    # numbers_1 = [random.randint(start, end) for i in range(0,batch_size)]
    # numbers_2 = [random.randint(start, end) for i in range(0,batch_size)]
    ...
    for i in range(0,batch_size):
        ...
        num_2=random.randint(start,end)
